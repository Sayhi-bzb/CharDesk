...
| Font capability | [`@chardesk/fonts`](../packages/fonts/README.md) | display/CJK/Nerd/symbol/emoji 字体路由；Host 与 Cell UI 的 Box/Block 使用[共享专用绘制器](../packages/rendering/README.md#cell-graphics)；[Host 字体偏好](research/font-stack.md#host-字体切换)不改变 Cell width |
