...
describe("Cell probe", () => {
  ...
  it("serializes component chrome as Unicode Cell text", () => {
    const pilot = createTestPilot({
      ...
      render: () => <Root><Box id="box" frame="bordered" style={{ width: 4, height: 3 }} /></Root>,
    });
