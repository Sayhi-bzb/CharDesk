...
const bridgeHtml = readFileSync(new URL("../../site/migration/bridge.html", import.meta.url), "utf8");
const bridgeScript = readFileSync(new URL("../../site/migration/bridge.js", import.meta.url), "utf8");
